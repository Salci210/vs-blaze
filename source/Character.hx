	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				case 'blaze':
					// BLAZE ANIMATION LOADING CODE
					tex = Paths.getSparrowAtlas('blazerino/Blaze_Assets');
					frames = tex;
					animation.addByPrefix('idle', 'Blaze Idle dance', 24);
					animation.addByPrefix('singUP', 'Blaze Up Note', 24);
					animation.addByPrefix('singRIGHT', 'Blaze Right Note', 24);
					animation.addByPrefix('singDOWN', 'Blaze Down Note', 24);
					animation.addByPrefix('singLEFT', 'Blaze Left Note', 24);
				...
				case 'blaze-dying':
					// BLAZE ANIMATION LOADING CODE
					tex = Paths.getSparrowAtlas('blazerino/Blaze_Assets2');
					frames = tex;
					animation.addByPrefix('idle', 'Blaze Idle dance', 24);
					animation.addByPrefix('singUP', 'Blaze Up Note', 24);
					animation.addByPrefix('singRIGHT', 'Blaze Right Note', 24);
					...
					case 'blaze-burned-out':
						// BLAZE ANIMATION LOADING CODE
						tex = Paths.getSparrowAtlas('blazerino/Blaze_Assets3');
						frames = tex;
						animation.addByPrefix('idle', 'Blaze Idle dance', 24);
						animation.addByPrefix('singUP', 'Blaze Up Note sing', 24);
						animation.addByPrefix('singRIGHT', 'Blaze Right note sing', 24);
						animation.addByPrefix('singDOWN', 'Blaze Down Note sing', 24);
						animation.addByPrefix('singLEFT', 'Blaze Left Note sing', 24);
