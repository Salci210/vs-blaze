...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		var firewo:Bool = PlayState.SONG.song.toLowerCase() != 'matches' && PlayState.SONG.song.toLowerCase() != 'fire' && PlayState.SONG.song.toLowerCase() != 'burned-out';
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase()=='fire')
		{
			swagDialogue.color = FlxColor.BLACK;
			dropText.color = FlxColor.WHITE;
		}
